...
4. Proporção de insatisfação:
  - Com atraso apresenta proporção de insatisfação acima do esperado (38%)
  - Sem atraso apresenta proporção inferior (21%), indicando maior satisfação relativa neste grupo. 
