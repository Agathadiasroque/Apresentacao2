...
1. De acordo com a proporção geral, as opiniões ficaram divididas 
...
4. Proporção de insatisfação:
  ...
  - Sem atraso apresentam proporção inferior (21%), indicando maior satisfação relativa neste grupo. 
